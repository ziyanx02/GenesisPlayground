...
EnvArgsRegistry["g1_walk"] = WalkingEnvArgs(
    ...
    reward_args={
        ...
        "LinVelYPenalty": 1.0,
        "LinVelZPenalty": 2.0,
        "AngVelXYPenalty": 0.05,
        ### Pose Tracking ###
        "OrientationPenalty": 10.0,
        ### Regularization ###
        "TorquePenalty": 1e-5,
        ...
        "StandStillAnkleTorquePenalty": 0.001,
        # "HipYawPenalty": 1.0,
        # "HipRollPenalty": 1.0,
        "HipPositionPenalty": 15.0,
        # "UpperBodyDofPenalty": 3.0,
        "UpperBodyActionPenalty": 0.5,
        "WaistDofPenalty": 50.0,
        # "FeetAirTimeReward": 200.0,
        "FeetAirTimePenalty": 500.0,
        "G1FeetHeightPenalty": 10.0,
        "G1FeetContactForcePenalty": 1.0e-05,
        "FeetZVelocityPenalty": 3,
        "FeetOrientationPenalty": 3,
        "StandStillFeetContactPenalty": 3e-4,
        "StandStillActionRatePenalty": 1.0,
        "G1FeetContactForceLimitPenalty": 5e-4,
    },
    img_resolution=(480, 270),
    action_latency=1,
    obs_history_len=1,
