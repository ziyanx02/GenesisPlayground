...
assistant = """
# The left foot's position is perfect now. I should adjust the right foot now.
# As shown in the rgb image from z, link 20 should be the right foot
right_foot_id = 20

# I should do the same adjustment to the right foot.
right_foot_pos = self.get_link_pos(right_foot_id)
right_foot_pos[0] -= 0.05
right_foot_pos[2] += 0.1
ik_success = self.set_link_pose(right_foot_id, right_foot_pos)
