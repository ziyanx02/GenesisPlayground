...
assistant = """
# The robot rotation is good now. I should adjust the foot position to let the robot stand better.
# As shown in the rgb image from z, link 18 should be the left foot
left_foot_id = 18

# The left foot is a little bit front of the robot center, so I should try to move it backward through inverse kinematics
